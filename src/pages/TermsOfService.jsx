                    ...
                    <AnimatedReveal>
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-7 py-6 mb-6">
                            ...
                            <div className="space-y-3 text-gray-600 text-sm leading-relaxed mt-3">
                                <p>
                                    This website is operated by <span className="font-semibold text-gray-800">Get Credentialing Done LLC</span>. Throughout the site, the terms "we", "us" and "our" refer to Get Credentialing Done LLC. Get Credentialing Done LLC offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                                </p>
                                <p>
                    ...
                    <div className="space-y-5">
                        ...
                        <AnimatedReveal delay={0.21}>
                            <SectionCard id="disclaimer" number={13} title="Disclaimer of Warranties; Limitation of Liability">
                                ...
                                <p>In no case shall Get Credentialing Done LLC, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>
                            </SectionCard>
                        </AnimatedReveal>

                        <AnimatedReveal delay={0.22}>
                            <SectionCard id="indemnification" number={14} title="Indemnification">
                                <p>You agree to indemnify, defend and hold harmless Get Credentialing Done LLC and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
                            </SectionCard>
                        </AnimatedReveal>
